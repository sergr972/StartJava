...
class VariablesTheme {
    public static void main(String[] args) {
        ...
        System.out.println("38 " + ch2);
        System.out.println("64 " + ch3);
        System.out.println("94 " + ch4);
        System.out.println("95 " + ch5);
        ...
        char backslash = '\\';
        char space = '_';
        char frontParenthesis = '(';
        char backParenthesis = ')';
        System.out.println("    " + forwardSlash + backslash);
        System.out.println("   " + forwardSlash + "  " + backslash);
        System.out.println("  " + forwardSlash + space + frontParenthesis + " " + backParenthesis + backslash);
        System.out.println(" " + forwardSlash + "      " + backslash);
        System.out.println("" + forwardSlash + space + space + space + space + forwardSlash + backslash + space + space + backslash);
        ...
        int num8 = number % 10;
        int sum2 = num6 + num7  + num8;
        int mult = num6 * num7 * num8;
        System.out.println("Сумма цифр числа " + number + " = " + sum2);
        System.out.println("Произведение цифр числа " + number + " = " + mult);
